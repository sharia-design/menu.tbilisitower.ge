    ...
    <div id="main-page">
        ...
        <main>
            ...
            <div class="main-head">
                ...
                <h3 class="main-head--cat">{{ __('front.all') }}</h3>
            </div>
            {{-- Main Headline --}}
            ...
            <section class="menu-list">
                ...
                <article class="menu-item trans" data-id="{{ $food->id }}" data-menu="food">
                    ...
                    <div class="menu-item--image">
                        <img src="{{ asset('public/uploads/food/' . $food->image) }}" alt="{{ $food['name_' . App::getLocale('lang')] }}" height="220" class="trans">
                    ...
                    <div class="menu-item--meta">
                        <div class="meta-text">
                            <h4 class="menu-item--name">
                                {{ $food['name_' . App::getLocale('lang')] }}
                            </h4>
                            <p class="meta-desc">
                            {{ mb_strimwidth($food['desc_' . App::getLocale('lang')], 0, 38, "..."); }}
                            </p>
                        </div>
