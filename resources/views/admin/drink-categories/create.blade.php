<x-back.layout>
    ...
    <x-slot name="title">დაამატე საჭმლის კატეგორია</x-slot>
    ...
    <div class="flex bg-transparent items-center justify-center">
        <div class="grid bg-white rounded-lg shadow-xl w-full  md:w-9/12 lg:w-2/3">
            ...
            <div class="flex mx-7 mt-5">
                <div class="flex">
                    <h1 class="text-gray-600 font-bold md:text-2xl text-xl">კერძების კატეგორიის დამატება</h1>
                </div>
            </div>

            <form action="/admin/drink-categories/create" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="flex flex-col m-4 p-4 rounded-md border-2 hover:border-blue-300 ease-in">
                    ...
                    <div class="flex w-full justify-between gap-1 sm:flex-col">
                        ...
                        <div class="grid grid-cols-1 mt-5">
                            ...
                            <input class="py-2 px-3 rounded-lg border-2 border-blue-300 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" name="name_ka" id="name_ka" type="text" value="{{ old('name_ka') }}" required placeholder="კერძის კატეგორია ქართულად" />
                            @error('name_ka')
